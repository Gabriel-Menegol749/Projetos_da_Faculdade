...
function botãologin() {
    ...
    if (logado) {
        frase.textContent = 'Faça seu Login!';
        logado = false;
        login.innerHTML = "Login";
        botãoDasenha.style.display = 'block';
        ...
        if (valornome === ''|| valorsenha === '') {
            alert("Preencha os campos para realizar Login!");
            return;
        }

        frase.textContent = valornome;
        logado = true;
        botãoDasenha.style.display = 'none';
